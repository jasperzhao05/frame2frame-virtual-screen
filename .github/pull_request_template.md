...
List the focused tests and their results. Run the matching contract check, or
mark it **N/A** with a reason:

- [ ] Filter behavior: `python -m scripts.benchmark_smoothing --check`
- [ ] Timing, rendering, or pipeline behavior: `python -m scripts.benchmark_pipeline --check`
- [ ] Public filter visual: `python -m scripts.make_showcase --out output/demo-comparison.gif`
