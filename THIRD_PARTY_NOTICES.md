...
default MediaPipe and FIR path, labeled as a software overlay, encoded at
360×360, and played forward then backward to make an 8.8-second looping GIF.
No per-frame reframing or manual screen keyframes are used. Fresh pose
observations were produced for 132 of 133 source frames (99.25%); that is a
per-clip operational measurement, not a claim of pose accuracy or general
robustness.
