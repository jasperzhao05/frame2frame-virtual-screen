...
This 15-second excerpt is shown at 2× playback with one fixed crop. It contains
changing background and illumination, continuous yaw/pitch motion, small body
translations, and one unedited 0.83-second observation gap. Stale geometry
clears, and the next fresh segment reacquires the plane. MediaPipe returned
fresh observations for 422 of 450 frames (93.8%); this is per-clip behavior,
