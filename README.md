...
![Two real Rokid scenes shown as original footage beside frame2frame output](docs/demo-rokid-outdoor.gif)

*Two clips, 11.93 seconds total, shown at 30 fps. Original footage is on the
left; `frame2frame` output is on the right.*

*Video source: BooredAtWork,
[“Rokid Glasses 2025 – Next Level Augmented Reality Experience!”](https://www.youtube.com/watch?v=abE88Vve0o4),
[CC BY 3.0](https://creativecommons.org/licenses/by/3.0/). The colored virtual
screen is generated by `frame2frame`, not the Rokid device; no affiliation or
