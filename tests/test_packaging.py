...
def test_source_distribution_excludes_readme_gifs():
    manifest = (_REPOSITORY_ROOT / "MANIFEST.in").read_text(encoding="utf-8")

    assert "recursive-exclude docs *.gif" in manifest.splitlines()
